  ...
  if (mode === 'alert') {
    ...
    setTimeout(() => {
      ...
      document
        ...
        .setAttribute('placeholder', i18next.t('toot.toot_as', { acct: now_userconf['username'] + '@' + inst }))
    }, 200)
  }
}
            ...
            if (ws_reshtml['id']) {
              if (toot_new_id !== ws_reshtml['id']) {
                ...
                if (home_auto_mode) {
                  ...
                  if (getConfig(1, 'chatmode'))
                    TlStoreData_pre[instance_ws][now_tab] += toot_card(ws_reshtml, 'full', null, TLmode)
                  else
                    TlStoreData_pre[instance_ws][now_tab] =
                      toot_card(ws_reshtml, 'full', null, TLmode) + TlStoreData_pre[instance_ws][now_tab]
