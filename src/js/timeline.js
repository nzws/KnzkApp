...
function openTL(mode) {
  ...
  if (mode === 'alert') {
    ...
    setTimeout(() => {
      ...
      document.getElementById('simple_toot_TL_input').setAttribute(
        'placeholder',
...
function scrollTL() {
  $('.page__content').scrollTop(
    getConfig(1, 'chatmode') ? 99999999999999999999999 : 0
  );
}
