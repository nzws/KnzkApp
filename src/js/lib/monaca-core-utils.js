...
(function() {
    ...
    for (var i = 0; i < arguments.length; i++) {
      ...
      if (isIOS) {
        ...
        if (!monaca.isMonacaDebuggerChecked || monaca.isMonacaDebugger) {
          ...
          if (
            window.monaca.isDeviceReady !== true ||
            (head != 'ERROR' && head != 'WARN:')
          ) {
            var xhr = new XMLHttpRequest();
            var path =
              'https://monaca-debugger.local/log?level=' +
  ...
  if (isIOS) {
    ...
    window.addEventListener(
      'error',
      function(desc, page, line, char) {
        monaca.console.sendLog('error', null, null, null, [
          {
      ...
      (n.fn = {
        ...
        attr: function(n, i) {
          ...
          return 'string' == typeof n && i === t
            ...
            : this.each(function(t) {
                if (1 === this.nodeType)
                  if (F(n)) for (e in n) U(this, e, n[e]);
  ...
  (window.Zepto = Zepto),
    ...
    (function(t) {
      ...
      (t.when = function(i) {
        ...
        if (o > 1)
          for (f = new Array(o), c = new Array(o), l = new Array(o); o > s; ++s)
                  ...
                  a = function(n) {
                    t.each(n, function(t, n) {
                      'function' == typeof n
                        ...
                        : n && n.length && 'string' != typeof n && a(n);
                    });
                  };
    ...
    var o = $.extend(
      true,
      {
        ...
        success: function(jsonResponse, status, xhr) {
          var sessionHeader = xhr.getResponseHeader(
            'X-Set-Monaca-Cloud-Session'
          );
          if (sessionHeader) {
          ...
          if (typeof jsonResponse.error !== 'undefined') {
            ...
            if (typeof jsonResponse.result.loginToken !== 'undefined') {
              localStorage.monacaCloudLoginToken =
                jsonResponse.result.loginToken;
            }
    ...
    MonacaCloudCollection.prototype = {
      ...
      _validateOptions: function(orderBy, options) {
        ...
        if (
          ...
          typeof orderBy.length === 'undefined'
        ) {
          options = orderBy;
          ...
          function(e, status, xhr, dfd) {
            var result =
              e.result.totalItems > 0
                ? self._makeCollectionItem(e.result.items[0])
                : null;
            dfd.resolve(result);
          }
        );
  ...
  monaca.cloud.User = (function() {
    return {
      ...
      logout: function() {
        ...
        monaca.cloud._post('User.logout', {}, dfd, {}, function() {
          self._oid = null;
          monaca.cloud._setSessionId('');
          localStorage.removeItem('monacaCloudLoginToken');
        });
